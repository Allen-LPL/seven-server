...
public class AuthController {
    ...
    public CommonResult<Boolean> sendEmailCode(@RequestBody @Valid AuthEmailSendReqVO reqVO,
        ...
        emailCodeApi.sendEmailCode(AuthEmailConvert.INSTANCE.convertEmailCodeSend(reqVO, clientIP));
        return success(true);
    }
    ...
    @PermitAll
    @Operation(summary = "重置邮箱密码")
    public CommonResult<Boolean> resetEmailPassword(@RequestBody @Valid AuthResetEmailPasswordReqVO reqVO) {
        authService.resetEmailPassword(reqVO);
        return success(true);
    }
