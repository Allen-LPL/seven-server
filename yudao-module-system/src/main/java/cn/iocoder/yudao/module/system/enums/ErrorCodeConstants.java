...
public interface ErrorCodeConstants {
    ...
    // ========== 邮箱验证码 1-002-025-100 ==========
    ErrorCode EMAIL_CODE_NOT_FOUND = new ErrorCode(1_002_025_100, "验证码不存在");
    ErrorCode EMAIL_CODE_EXPIRED = new ErrorCode(1_002_025_101, "验证码已过期");
    ErrorCode EMAIL_CODE_USED = new ErrorCode(1_002_025_102, "验证码已使用");
    ErrorCode EMAIL_CODE_EXCEED_SEND_MAXIMUM_QUANTITY_PER_DAY = new ErrorCode(1_002_025_103, "超过每日邮箱发送数量");
    ErrorCode EMAIL_CODE_SEND_TOO_FAST = new ErrorCode(1_002_025_104, "邮箱发送过于频繁");
    ErrorCode USER_EMAIL_NOT_EXISTS = new ErrorCode(1_002_025_105, "该邮箱尚未注册");
