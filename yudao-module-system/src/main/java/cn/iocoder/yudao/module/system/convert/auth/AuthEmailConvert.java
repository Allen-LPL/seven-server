...
@Mapper
public interface AuthEmailConvert {

    AuthEmailConvert INSTANCE = Mappers.getMapper(AuthEmailConvert.class);
    ...
    default List<AuthPermissionInfoRespVO.MenuVO> buildMenuTree(List<MenuDO> menuList) {
        ...
        menuList.forEach(menu -> treeNodeMap.put(menu.getId(), AuthEmailConvert.INSTANCE.convertTreeNode(menu)));
        // 处理父子关系
